...
# Cache to store purge start points per chat
purge_points = {}

# /purge <count> or reply → purge until current
@admin_required
...
# /spurge — silent purge (no reply) between replied and command
@admin_required
...
# /del — delete replied + command message
@admin_required
...
# /purgefrom — mark point to start purge
@admin_required
...
# /purgeto — purge from marked point to command message
@admin_required
...
# Register all purge-related handlers

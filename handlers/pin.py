...
# Pin a message (silent by default, loud with 'loud' flag)
@admin_required
...
# Permapin (create and pin a text message)
@admin_required
...
# Enable or disable anti-channel pin (auto remove messages pinned by channels)
@admin_required
